        ...
        {messages.map((message) => (
          ...
          >
            ...
            <div className="flex-1">
              ...
              <motion.div
                className={`rounded-2xl p-4 shadow-sm ${message.type === 'text' ? 'bg-gradient-to-br from-gray-50 to-gray-100' : 'bg-white border border-gray-200'
                  }`}
          ...
          <div className="flex items-center justify-between px-4 py-2 border-t border-gray-200 bg-gray-50">
            <div className="flex items-center gap-1">
              ...
              <button
                ...
                className={`p-2 hover:bg-white rounded-lg transition-colors relative group ${isRecording ? 'text-red-500' : 'text-gray-500 hover:text-blue-600'
                  }`}
              >
